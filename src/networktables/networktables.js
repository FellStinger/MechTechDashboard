var NetworkTables =
    (() => {
        let keys = {}, connectionListeners = [], connected = false, globalListeners = [], keyListeners = [], address = '127.0.0.1';
        ...
        window.api.onAdd((ev, msg) => {
            ...
            if (globalListeners.length > 0) { keys[msg.key].new = false; }
        ...
        window.api.onDelete((ev, msg) => {
            delete keys[msg.key];
        });

        window.api.onUpdate((ev, msg) => {
        ...
        window.api.onFlagChange((ev, msg) => {
        ...
        var d3_map = function () {
            ...
            this.getKeys = function () {
                var keys = [];
                for (var key in this._) { keys.push(d3_map_escape(key)); }
                return keys;
            };
        ...
        return {
             ...
             * 
             * @returns All keys in the NetworkTables
             */
            getKeys() {
